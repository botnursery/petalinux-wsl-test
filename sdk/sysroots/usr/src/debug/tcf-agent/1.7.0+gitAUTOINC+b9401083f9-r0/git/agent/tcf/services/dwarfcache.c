...
static void read_object_info(U2_T Tag, U2_T Attr, U2_T Form) {
    ...
    case AT_location:
        ...
        if (Form == FORM_DATA1 || Form == FORM_DATA2 || Form == FORM_DATA4 || Form == FORM_DATA8 || Form == FORM_SEC_OFFSET || Tag == TAG_formal_parameter) {
            Info->mFlags |= DOIF_need_frame;
        }
        break;
    case AT_data_location:
        ...
        if (Form == FORM_DATA1 || Form == FORM_DATA2 || Form == FORM_DATA4 || Form == FORM_DATA8 || Form == FORM_SEC_OFFSET) {
            Info->mFlags |= DOIF_need_frame;
        }
        break;
